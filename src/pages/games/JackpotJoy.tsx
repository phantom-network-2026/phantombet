...
const theme: SlotTheme = {
  ...
  symbols: [
    { id: "trophy",   emoji: "🏆", pay: [1, 4, 15, 60], weight: 1, tier: "premium", label: "Trophy" },
    { id: "moneybag", emoji: "💰", pay: [0.8, 3, 12, 45], weight: 4, tier: "premium", label: "Cash" },
    { id: "gem",      emoji: "💎", pay: [0.6, 2, 8, 30], weight: 6, tier: "high",    label: "Gem" },
    { id: "ring",     emoji: "💍", pay: [0.5, 1.6, 6, 24], weight: 7, tier: "high",  label: "Ring" },
    { id: "balloon",  emoji: "🎈", pay: [0.4, 1.2, 4, 15], weight: 9, tier: "mid",    label: "Balloon" },
    { id: "cake",     emoji: "🎂", pay: [0.4, 1.2, 4, 15], weight: 9, tier: "mid",    label: "Cake" },
    { id: "gift",     emoji: "🎁", pay: [0.35, 1, 3.5, 12], weight: 10, tier: "mid",   label: "Gift" },
    { id: "popper",   emoji: "🎊", pay: [0.35, 1, 3.5, 12], weight: 10, tier: "mid",   label: "Popper" },
    { id: "ticket",   emoji: "🎫", pay: [0.25, 0.7, 2.5, 8], weight: 12, tier: "low", label: "Ticket" },
    { id: "drum",     emoji: "🥁", pay: [0.25, 0.7, 2.5, 8], weight: 12, tier: "low", label: "Drum" },
    { id: "guitar",   emoji: "🎸", pay: [0.2, 0.5, 2, 6], weight: 13, tier: "low",  label: "Guitar" },
    { id: "candy",    emoji: "🍭", pay: [0.2, 0.5, 2, 6], weight: 13, tier: "low",  label: "Candy" },
    { id: "party",    emoji: "🎉", pay: [1.5, 5, 20, 100], weight: 1, tier: "wild",   label: "WILD PARTY" },
  ],
  wildId: "party",
  scatterId: "trophy",
