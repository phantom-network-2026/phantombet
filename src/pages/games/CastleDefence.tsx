...
const theme: SlotTheme = {
  ...
  symbols: [
    { id: "dragon",  emoji: "🐉", pay: [1, 4, 15, 60], weight: 1, tier: "premium", label: "Dragon" },
    { id: "castle",  emoji: "🏰", pay: [0.8, 3, 12, 45], weight: 4, tier: "premium", label: "Castle" },
    { id: "knight",  emoji: "🤴", pay: [0.6, 2, 8, 30], weight: 6, tier: "high",    label: "King" },
    { id: "queen",   emoji: "👸", pay: [0.5, 1.6, 6, 24], weight: 7, tier: "high",  label: "Queen" },
    { id: "sword",   emoji: "⚔️", pay: [0.4, 1.2, 4, 15], weight: 9, tier: "mid",   label: "Swords" },
    { id: "shield",  emoji: "🛡️", pay: [0.4, 1.2, 4, 15], weight: 9, tier: "mid",   label: "Shield" },
    { id: "bow",     emoji: "🏹", pay: [0.35, 1, 3.5, 12], weight: 10, tier: "mid",  label: "Bow" },
    { id: "axe",     emoji: "🪓", pay: [0.35, 1, 3.5, 12], weight: 10, tier: "mid",  label: "Axe" },
    { id: "torch",   emoji: "🔥", pay: [0.25, 0.7, 2.5, 8], weight: 12, tier: "low", label: "Torch" },
    { id: "scroll",  emoji: "📜", pay: [0.25, 0.7, 2.5, 8], weight: 12, tier: "low", label: "Scroll" },
    { id: "potion",  emoji: "🧪", pay: [0.2, 0.5, 2, 6], weight: 13, tier: "low", label: "Potion" },
    { id: "helm",    emoji: "⛑️", pay: [0.2, 0.5, 2, 6], weight: 13, tier: "low", label: "Helm" },
    { id: "crown",   emoji: "👑", pay: [1.5, 5, 20, 100], weight: 1, tier: "wild",   label: "WILD CROWN" },
  ],
  wildId: "crown",
  scatterId: "dragon",
