...
const theme: SlotTheme = {
  ...
  symbols: [
    { id: "dragon",  emoji: "🐉", pay: [0.5, 1.5, 5, 20], weight: 1, tier: "premium", label: "Dragon" },
    { id: "castle",  emoji: "🏰", pay: [0.4, 1.2, 4, 15], weight: 4, tier: "premium", label: "Castle" },
    { id: "knight",  emoji: "🤴", pay: [0.3, 0.9, 3, 10], weight: 6, tier: "high",    label: "King" },
    { id: "queen",   emoji: "👸", pay: [0.25, 0.7, 2.5, 8], weight: 7, tier: "high",  label: "Queen" },
    { id: "sword",   emoji: "⚔️", pay: [0.15, 0.4, 1.5, 5], weight: 9, tier: "mid",   label: "Swords" },
    { id: "shield",  emoji: "🛡️", pay: [0.15, 0.4, 1.5, 5], weight: 9, tier: "mid",   label: "Shield" },
    { id: "bow",     emoji: "🏹", pay: [0.12, 0.3, 1.2, 4], weight: 10, tier: "mid",  label: "Bow" },
    { id: "axe",     emoji: "🪓", pay: [0.12, 0.3, 1.2, 4], weight: 10, tier: "mid",  label: "Axe" },
    { id: "torch",   emoji: "🔥", pay: [0.08, 0.2, 0.7, 2.5], weight: 12, tier: "low", label: "Torch" },
    { id: "scroll",  emoji: "📜", pay: [0.08, 0.2, 0.7, 2.5], weight: 12, tier: "low", label: "Scroll" },
    { id: "potion",  emoji: "🧪", pay: [0.05, 0.15, 0.5, 2], weight: 13, tier: "low", label: "Potion" },
    { id: "helm",    emoji: "⛑️", pay: [0.05, 0.15, 0.5, 2], weight: 13, tier: "low", label: "Helm" },
    { id: "crown",   emoji: "👑", pay: [0.8, 2.5, 10, 40], weight: 1, tier: "wild",   label: "WILD CROWN" },
  ],
  wildId: "crown",
  scatterId: "dragon",
