...
const theme: SlotTheme = {
  ...
  symbols: [
    { id: "shark",    emoji: "🦈", pay: [1, 4, 15, 60], weight: 1, tier: "premium", label: "Shark" },
    { id: "boat",     emoji: "⛵", pay: [0.8, 3, 12, 45], weight: 4, tier: "premium", label: "Boat" },
    { id: "bigfish",  emoji: "🐠", pay: [0.6, 2, 8, 30], weight: 6, tier: "high",    label: "Tropical" },
    { id: "octopus",  emoji: "🐙", pay: [0.5, 1.6, 6, 24], weight: 7, tier: "high",  label: "Octopus" },
    { id: "fish",     emoji: "🐟", pay: [0.4, 1.2, 4, 15], weight: 9, tier: "mid",    label: "Fish" },
    { id: "puffer",   emoji: "🐡", pay: [0.4, 1.2, 4, 15], weight: 9, tier: "mid",    label: "Puffer" },
    { id: "crab",     emoji: "🦀", pay: [0.35, 1, 3.5, 12], weight: 10, tier: "mid",   label: "Crab" },
    { id: "shrimp",   emoji: "🦐", pay: [0.35, 1, 3.5, 12], weight: 10, tier: "mid",   label: "Shrimp" },
    { id: "shell",    emoji: "🐚", pay: [0.25, 0.7, 2.5, 8], weight: 12, tier: "low", label: "Shell" },
    { id: "anchor",   emoji: "⚓", pay: [0.25, 0.7, 2.5, 8], weight: 12, tier: "low", label: "Anchor" },
    { id: "wave",     emoji: "🌊", pay: [0.2, 0.5, 2, 6], weight: 13, tier: "low",  label: "Wave" },
    { id: "chest",    emoji: "💎", pay: [0.2, 0.5, 2, 6], weight: 13, tier: "low",  label: "Pearl" },
    { id: "hook",     emoji: "🎣", pay: [1.5, 5, 20, 100], weight: 1, tier: "wild",   label: "WILD HOOK" },
  ],
  wildId: "hook",
  scatterId: "shark",
