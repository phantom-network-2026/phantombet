...
const theme: SlotTheme = {
  ...
  symbols: [
    { id: "seven",   emoji: "7️⃣", pay: [2, 8, 30, 150], weight: 1, tier: "premium", label: "Lucky 7" },
    { id: "diamond", emoji: "💎", pay: [1, 4, 15, 60], weight: 4, tier: "premium", label: "Diamond" },
    { id: "bell",    emoji: "🔔", pay: [0.8, 3, 12, 45], weight: 6, tier: "high",   label: "Bell" },
    { id: "money",   emoji: "💵", pay: [0.6, 2, 8, 30], weight: 7, tier: "high",   label: "Money" },
    { id: "bar",     emoji: "🅱️", pay: [0.5, 1.5, 6, 20], weight: 9, tier: "mid",    label: "BAR" },
    { id: "cherry",  emoji: "🍒", pay: [0.5, 1.5, 6, 20], weight: 9, tier: "mid",    label: "Cherry" },
    { id: "lemon",   emoji: "🍋", pay: [0.4, 1.2, 4, 15], weight: 10, tier: "mid", label: "Lemon" },
    { id: "grape",   emoji: "🍇", pay: [0.4, 1.2, 4, 15], weight: 10, tier: "mid", label: "Grape" },
    { id: "watermelon", emoji: "🍉", pay: [0.3, 0.9, 3, 12], weight: 12, tier: "low", label: "Melon" },
    { id: "orange",  emoji: "🍊", pay: [0.3, 0.9, 3, 12], weight: 12, tier: "low",   label: "Orange" },
    { id: "card",    emoji: "🃏", pay: [0.2, 0.5, 2, 6], weight: 13, tier: "low", label: "Card" },
    { id: "dice",    emoji: "🎲", pay: [0.2, 0.5, 2, 6], weight: 13, tier: "low", label: "Dice" },
    { id: "star",    emoji: "⭐", pay: [1.5, 5, 20, 100], weight: 1, tier: "wild",  label: "WILD STAR" },
  ],
  wildId: "star",
  scatterId: "seven",
