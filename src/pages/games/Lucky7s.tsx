...
const theme: SlotTheme = {
  ...
  symbols: [
    { id: "seven",   emoji: "7️⃣", pay: [5, 20, 80, 400], weight: 1, tier: "premium", label: "Lucky 7" },
    { id: "diamond", emoji: "💎", pay: [3, 12, 50, 200], weight: 4, tier: "premium", label: "Diamond" },
    { id: "bell",    emoji: "🔔", pay: [2.5, 10, 40, 150], weight: 6, tier: "high",   label: "Bell" },
    { id: "money",   emoji: "💵", pay: [2, 7, 25, 100], weight: 7, tier: "high",   label: "Money" },
    { id: "bar",     emoji: "🅱️", pay: [1.5, 5, 18, 70], weight: 9, tier: "mid",    label: "BAR" },
    { id: "cherry",  emoji: "🍒", pay: [1.5, 5, 18, 70], weight: 9, tier: "mid",    label: "Cherry" },
    { id: "lemon",   emoji: "🍋", pay: [1.2, 4, 14, 50], weight: 10, tier: "mid", label: "Lemon" },
    { id: "grape",   emoji: "🍇", pay: [1.2, 4, 14, 50], weight: 10, tier: "mid", label: "Grape" },
    { id: "watermelon", emoji: "🍉", pay: [1, 3, 10, 40], weight: 12, tier: "low", label: "Melon" },
    { id: "orange",  emoji: "🍊", pay: [1, 3, 10, 40], weight: 12, tier: "low",   label: "Orange" },
    { id: "card",    emoji: "🃏", pay: [0.6, 2, 7, 22], weight: 13, tier: "low", label: "Card" },
    { id: "dice",    emoji: "🎲", pay: [0.6, 2, 7, 22], weight: 13, tier: "low", label: "Dice" },
