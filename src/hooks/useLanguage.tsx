...
const translations = {
  en: {
    ...
    admin: "Admin Panel", cpanel: "cPanel", slotPanel: "Game Panel", ownerPanel: "Owner Panel",
  ...
  es: {
    ...
    admin: "Panel Admin", cpanel: "cPanel", slotPanel: "Panel de Juegos", ownerPanel: "Panel Dueño",
  ...
  fr: {
    ...
    admin: "Panneau Admin", cpanel: "cPanel", slotPanel: "Panneau Jeux", ownerPanel: "Panneau Proprio",
  ...
  de: {
    ...
    admin: "Admin-Panel", cpanel: "cPanel", slotPanel: "Spiel-Panel", ownerPanel: "Owner-Panel",
  ...
  pt: {
    ...
    admin: "Painel Admin", cpanel: "cPanel", slotPanel: "Painel Jogos", ownerPanel: "Painel Dono",
  ...
  it: {
    ...
    admin: "Pannello Admin", cpanel: "cPanel", slotPanel: "Pannello Giochi", ownerPanel: "Pannello Proprietario",
  ...
  nl: {
    ...
    admin: "Admin Paneel", cpanel: "cPanel", slotPanel: "Spel Paneel", ownerPanel: "Eigenaar Paneel",
  ...
  ru: {
    ...
    admin: "Админ панель", cpanel: "cPanel", slotPanel: "Игровая панель", ownerPanel: "Панель владельца",
  ...
  pl: {
    ...
    admin: "Panel Admina", cpanel: "cPanel", slotPanel: "Panel Gier", ownerPanel: "Panel Właściciela",
  ...
  uk: {
    ...
    admin: "Адмін панель", cpanel: "cPanel", slotPanel: "Ігрова панель", ownerPanel: "Панель власника",
  ...
  tr: {
    ...
    admin: "Admin Paneli", cpanel: "cPanel", slotPanel: "Game Paneli", ownerPanel: "Sahip Paneli",
