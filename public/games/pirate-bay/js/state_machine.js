...
class PreSpinState
{
    ...
    enterFrom(oldState)
    {
        ...
        if (!this.slotControls.hasFreeSpin() && (this.slotControls.getTotalBet() > this.slotPlayer.coins))
        {
...
class AutoSpinState
{
    ...
    constructor(scene,  stateMachine)
     ...
     enterFrom(oldState)
     {
        ...
        this.slotControls.setSpinButtonText(this.slotControls.spinTextString);
...
class WinState 
{
    ...
    enterFrom(oldState)
    {
        ...
        this.slotControls.setSpinButtonText(this.slotControls.freeSpins > 0 ? this.slotControls.freeSpins : this.slotControls.spinTextString);
